...
//-----------------------------------------------------------------------------
//----- ADSKDbEmployeeReactor.h : Declaration of the ADSKDbEmployeeReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ ADSKDbEmployeeReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(ADSKDbEmployeeReactor) ;
...
public:
	ADSKDbEmployeeReactor (AcDbDatabase *pDb =NULL) ;
	virtual ~ADSKDbEmployeeReactor () ;
...
#ifdef STEP07_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(ADSKDbEmployeeReactor)
#endif
