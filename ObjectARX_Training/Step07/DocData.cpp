...
CDocData::CDocData() 
	: m_editCommand{ false }, m_doRepositioning{ false } 
{
...
CDocData::CDocData (const CDocData &data) 
	: m_editCommand{ data.m_editCommand }, m_doRepositioning{ data.m_doRepositioning },
	m_changedObjects{ data.m_changedObjects }, m_employeePositions{ data.m_employeePositions }
{
	attachEmployeeReactorToAllEmployee (true) ;
}
